get_summary_normal <- function(sim_sces, true_value = 5) {
  # Compute MSE
  ...
  # away real information for no apparent reason. Same bug as
  # get_summary_bin.r had; removed so the printed xtable actually shows
  # which scenario each row belongs to.
  ...
  return(list(summary_table = summary_table,
              ...
              bcis_80 = bcis_80,
              bcis_50 = bcis_50,
              coverages_95 = coverages_95,
              coverages_90 = coverages_90,
              coverages_80 = coverages_80,
